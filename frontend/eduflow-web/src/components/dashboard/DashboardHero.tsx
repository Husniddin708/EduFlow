...
export const DashboardHero: React.FC = () => {
  ...
  const greeting = isMorning
    ...
    : `Xayrli oqshom, ${user?.firstName || 'Foydalanuvchi'}!`;

  return (
    <div className="relative overflow-hidden rounded-3xl p-6 sm:p-8 transition-all duration-500 border group shadow-lg">
      ...
      />
      <div
        className={`absolute -left-16 -bottom-16 w-64 h-64 rounded-full blur-3xl pointer-events-none transition-all duration-500 ${
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              ...
              <span>{isMorning ? 'Tonggi tetiklik rejimi' : 'Kechki qulay ko‘z himoyasi'}</span>
            </span>

            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20">
              <span className="w-2 h-2 rounded-full bg-emerald-500 animate-ping" />
              <span>EduFlow SaaS Faol</span>
            </span>

            {/* Live Clock with Ticking Seconds */}
            <div className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-mono font-bold bg-slate-900/5 dark:bg-white/10 text-slate-700 dark:text-slate-200 border border-slate-300/40 dark:border-white/10">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 mt-2 max-w-xl leading-relaxed">
              {isMorning
                ? `Bugun yangi yutuqlar va darslar kuni. O‘quvchilaringiz bilim olishga tayyor! (${organization?.name || "EduFlow Platformasi"})`
                : `Bugungi darslar, davomat va to‘lovlar hisobotlarini ko‘rib chiqishingiz mumkin. Ko‘zlaringizga dam bering!`}
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            <Link
              to="/attendance"
              className="px-5 py-2.5 rounded-xl text-xs font-bold text-white bg-gradient-to-r from-[#0050cb] to-[#0066ff] hover:from-[#003fa4] hover:to-[#0050cb] shadow-md hover:shadow-lg transition-all flex items-center gap-2 hover:-translate-y-0.5 cursor-pointer"
            >
              <Sparkles className="w-4 h-4 text-yellow-300" />
              <span>Tezkor Davomat Qilish</span>
            </Link>

            <Link
              to="/students"
              className="px-4 py-2.5 rounded-xl text-xs font-bold bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 shadow-xs transition-all flex items-center gap-2 hover:-translate-y-0.5 cursor-pointer"
            >
        ...
        {/* Right Column: Animated Visual Art / Educational Illustration */}
        <div className="lg:col-span-5 flex justify-center lg:justify-end">
          <div className="relative w-full max-w-[340px] aspect-4/3 flex items-center justify-center">
            ...
            <div className="relative z-10 w-full p-5 rounded-2xl bg-white/70 dark:bg-slate-900/70 border border-white/60 dark:border-slate-700/60 shadow-xl backdrop-blur-xl transition-all duration-300 hover:scale-[1.02]">
              ...
              <div className="grid grid-cols-2 gap-2.5 mt-3">
                <div className="p-2.5 rounded-xl bg-slate-50/80 dark:bg-slate-800/80 border border-slate-100 dark:border-slate-700/60 flex items-center gap-2.5 transition-transform hover:scale-102">
                  ...
                  <div>
                    <span className="text-[10px] text-slate-500 dark:text-slate-400 block leading-tight">Tezkor</span>
                    <span className="text-xs font-extrabold text-slate-800 dark:text-slate-200">Davomat</span>
                  </div>
                </div>
                ...
                <div className="p-2.5 rounded-xl bg-slate-50/80 dark:bg-slate-800/80 border border-slate-100 dark:border-slate-700/60 flex items-center gap-2.5 transition-transform hover:scale-102">
                  ...
                  <div>
                    <span className="text-[10px] text-slate-500 dark:text-slate-400 block leading-tight">Telegram</span>
                    <span className="text-xs font-extrabold text-slate-800 dark:text-slate-200">Xabarnoma</span>
                  </div>
                </div>
                ...
                <div className="p-2.5 rounded-xl bg-slate-50/80 dark:bg-slate-800/80 border border-slate-100 dark:border-slate-700/60 flex items-center gap-2.5 transition-transform hover:scale-102">
                  ...
                  <div>
                    <span className="text-[10px] text-slate-500 dark:text-slate-400 block leading-tight">Moliya</span>
                    <span className="text-xs font-extrabold text-slate-800 dark:text-slate-200">To‘lovlar</span>
                  </div>
                </div>
                ...
                <div className="p-2.5 rounded-xl bg-slate-50/80 dark:bg-slate-800/80 border border-slate-100 dark:border-slate-700/60 flex items-center gap-2.5 transition-transform hover:scale-102">
                  ...
                  <div>
                    <span className="text-[10px] text-slate-500 dark:text-slate-400 block leading-tight">Xavfsiz</span>
                    <span className="text-xs font-extrabold text-slate-800 dark:text-slate-200">SaaS Cloud</span>
                  </div>
                </div>
              </div>
