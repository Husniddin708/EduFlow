...
export const ReportsPage: React.FC = () => {
  ...
  if (loading) return <LoadingSpinner text="Analitika va hisobotlar tayyorlanmoqda..." />;

  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      <StartupBanner
        badgeText="Data & Growth Intelligence 📊"
        title="Analitika va Hisobotlar Markazi"
        description="O‘quv markazi davomat ko‘rsatkichlari, oylik tushumlar o‘sish dinamikasi va o‘quvchilar oqimi tahlili."
      ...
      <div className="flex bg-white dark:bg-slate-900 p-1.5 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-xs max-w-xl gap-1 overflow-x-auto">
        {[
          { id: 'attendance', label: 'Davomat hisoboti', icon: CheckCircle },
          { id: 'payments', label: 'Moliya va To‘lovlar', icon: CreditCard },
          { id: 'students', label: 'O‘quvchilar tahlili', icon: Users },
        ].map((tab) => {
          const Icon = tab.icon;
          return (
            <button
