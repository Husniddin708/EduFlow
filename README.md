...
|---|---|---|---|
| **Admin (To'liq huquqli)** | `admin@eduflow.uz` | `admin123` | Barcha huquqlar (Platforma, Tashkilot, O'quvchilar, Guruhlar, Moliya, Sozlamalar) |
| **Teacher (O'qituvchi)** | `teacher@smartedu.uz` | `admin123` | Darslar, davomat belgilash, baholash |
